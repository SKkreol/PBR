    ...
    */
    ...
    float3 computeF0(const half4 baseColor, float metallic, float reflectance) {
        return baseColor.rgb * metallic + (reflectance * (float(1.0) - metallic));
    }

    float computeDielectricF0(float reflectance) {
        return float(0.16) * reflectance * reflectance;
    }
